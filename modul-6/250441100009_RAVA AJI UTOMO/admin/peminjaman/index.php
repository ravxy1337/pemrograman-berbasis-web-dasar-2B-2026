...
$koneksi->query("UPDATE peminjaman SET status = 'terlambat' WHERE status = 'dipinjam' AND tanggal_kembali < CURDATE()");
?>
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    ...
                    $query = mysqli_query($koneksi, "
                        SELECT p.*, pg.nama_lengkap, b.judul 
                        FROM peminjaman p 
                    ...
                    if (mysqli_num_rows($query) > 0):
                        while ($row = mysqli_fetch_assoc($query)):
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="ubah_status.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary"
                                        title="Ubah Status">
