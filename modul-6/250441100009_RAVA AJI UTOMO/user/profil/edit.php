                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 text-center mb-3 mb-md-0">
                            ...
                            <img src="<?= $foto ?>" alt="Foto Profil" class="img-fluid rounded-circle mb-3"
                                style="width: 150px; height: 150px; object-fit: cover; border: 3px solid var(--warna-latar);">
                            <div class="mb-3">
                                <label for="foto_profil" class="form-label d-block text-start">Ganti Foto</label>
                                <input class="form-control form-control-sm" type="file" id="foto_profil"
                                    name="foto_profil" accept=".jpg,.jpeg,.png,.webp">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="no_telp" name="no_telp"
                                value="<?= htmlspecialchars((string) $user['no_telp']) ?>">
                        </div>
                        <div class="col-md-12 mb-4">
                            <label for="alamat" class="form-label">Alamat</label>
                            <textarea class="form-control" id="alamat" name="alamat"
                                rows="3"><?= htmlspecialchars((string) $user['alamat']) ?></textarea>
                        </div>
                    </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="" method="POST" id="formPassword">
                    ...
                    <div class="mb-3">
                        <label for="kata_sandi_lama" class="form-label">Kata Sandi Lama <span
                                class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="kata_sandi_lama" name="kata_sandi_lama"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="kata_sandi_baru" class="form-label">Kata Sandi Baru <span
                                class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="kata_sandi_baru" name="kata_sandi_baru"
                            minlength="8" required>
                    </div>
                    <div class="mb-4">
                        <label for="konfirmasi_kata_sandi_baru" class="form-label">Konfirmasi Sandi Baru <span
                                class="text-danger">*</span></label>
                        <input type="password" class="form-control" id="konfirmasi_kata_sandi_baru"
                            name="konfirmasi_kata_sandi_baru" minlength="8" required>
                    </div>
